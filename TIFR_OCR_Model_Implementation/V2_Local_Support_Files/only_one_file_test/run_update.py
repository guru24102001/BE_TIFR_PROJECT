...
images = 'D:/Akaash/VESIT_BE_PROJECT/YOLO_v5_Character_Updated/V2_Local_Support_Files/only_one_file_test/'
...
for im in os.listdir(images):
    ...
    if (im.endswith(".jpg")):
        ...
        for i in range(size_of_table-1):
            if(test_output_read['xmin'][i+1] - test_output_read['xmax'][i] > 300):
                index2 = i;
        # print("Done")
        
        i=0
        while(i < index2):
            if(test_output_read['xmin'][index2] - test_output_read['xmax'][i] > 116):
                index1 = i;
            i = i+1
        # print("Done")
        ...
        i = size_of_table-1
        while (i > index2):
            if(test_output_read['xmin'][i] - test_output_read['xmax'][index2] > 350):
                index3 = i;
            i = i-1
        # print("Done")
